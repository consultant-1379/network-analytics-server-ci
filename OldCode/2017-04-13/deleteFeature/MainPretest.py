...
#2ndStart
allArr=["test","TWAMP","RANCapacityManagement","LTEOpt","VoLTE","VoWIFI","Energy"]#holds the names of all the feature names
#2ndEnd
...
try:
    ...
    for counter,x in enumerate(typeArr):
        ...
        if TYPE=="LTEOpt":
            ...
            mainReturn=testMain.testMain(DATETIME_ID,configTime,path,timeElem,configType,KPI_VALUE,NODE_NAME,splitNode19,TYPE,crsr,decimalPlaces,nodeNameList,headerNameList,KPINameList,dashHeaderList,dashList)
#3rd
