...
try:
    ...
    parser.add_argument("-ef",help="Test the parser")	#edit- remove this
    parser.add_argument("-er",help="Test the parser")
    parser.add_argument("-edk",help="Test the parser")
    parser.add_argument("-ek",help="Test the parser")
    parser.add_argument("-edf",help="Test the parser")
