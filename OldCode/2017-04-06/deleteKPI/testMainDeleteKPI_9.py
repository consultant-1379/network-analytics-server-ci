def sourceWritetest(sourceResults,crsr,SQLConfig,noSpace,HTMLTable,erbsArr,erbsHeadArr,result,decimalPlaces,KPIHeader,dashArr,dashHeader):
    ...
    for row in rowSour:
        ...
        if SQLConfig[0]=='6':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

        if SQLConfig[0]=='7':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

        if SQLConfig[0]=='8':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

        if SQLConfig[0]=='9':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

        if SQLConfig[0]=='10':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

        if SQLConfig[0]=='11':	#scruppy edit-
            col4.append(row[4])
            col5.append(row[5])

#1st

    if SQLConfig[0]=='1':#wabaloba
        test2=list(col2)
        test1=list(col1)
        ForTest1=[]
    ...
    if SQLConfig[0]=='10':	#jim jam edit-
        test4=list(col4)
        test5=list(col5)
        ForTest5=[]
        for number in range(len(test5)):
    ...
    if SQLConfig[0]=='11':	#jim jam edit-
        test4=list(col4)
        test5=list(col5)
        ForTest5=[]
        for number in range(len(test5)):
