...
import newFeature.newFeatureMain as newFeatureMain
...
#2ndStart
allArr=["newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","newFeature","LTEOpt","VoLTE","VoWIFI","Energy"]
#2ndEnd
    ...
    for counter,x in enumerate(typeArr):
        ...
        if TYPE=="LTEOpt":
            ...
            mainReturn=EnergyMain.EnergyMain(DATETIME_ID,configTime,path,timeElem,configType,KPI_VALUE,NODE_NAME,splitNode19,TYPE,crsr,decimalPlaces,nodeNameList,headerNameList,KPINameList,dashHeaderList,dashList)
                ...
                mainReturn=newFeatureMain.newFeatureMain(DATETIME_ID,configTime,path,timeElem,configType,KPI_VALUE,NODE_NAME,splitNode19,TYPE,crsr,decimalPlaces,nodeNameList,headerNameList,KPINameList,dashHeaderList,dashList)
        elif TYPE=="newFeature":
                mainReturn=newFeatureMain.newFeatureMain(DATETIME_ID,configTime,path,timeElem,configType,KPI_VALUE,NODE_NAME,splitNode19,TYPE,crsr,decimalPlaces,nodeNameList,headerNameList,KPINameList,dashHeaderList,dashList)
        elif TYPE=="newFeature":
                mainReturn=newFeatureMain.newFeatureMain(DATETIME_ID,configTime,path,timeElem,configType,KPI_VALUE,NODE_NAME,splitNode19,TYPE,crsr,decimalPlaces,nodeNameList,headerNameList,KPINameList,dashHeaderList,dashList)
